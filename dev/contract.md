# Contract
`Tyco` use `EVM` for contract execution.See [Solidity](https://docs.soliditylang.org/en/v0.7.1/#) for detail.
...
And then by `MetaMask` the contract deployemnt transaction can be broadcast to the tyco chain.
...
module.exports = {
  networks: {
    ...
    mainnet: {
      provider: () => new HDWalletProvider(mnemonic, 'https://http-mainnet.tycoscan.com'),
      network_id: 128
    }
  },
